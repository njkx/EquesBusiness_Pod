...
#pragma mark 新的PIR获取接口URL
+ (NSURL *)equesGetAlarmCountUrl:(NSString *)bid;
+ (NSURL *)equesGetDeviceAlarmList:(NSString *)bid startTime:(long long)startTime endTime:(long long)endTime;
#pragma mark 新的锁消息获取接口URL
+ (NSURL *)equesGetLockMessageUrlWithBid:(NSString *)bid lid:(NSString *)lid;
+ (NSURL *)eqeusGetLockMessageListUrlWithBid:(NSString *)bid lid:(NSString *)lid startTime:(long long)startTime endTime:(long long)endTime;
#pragma mark 新的锁警告消息接口URL
+ (NSURL *)equesGetLockAlarmUrlWithBid:(NSString *)bid lid:(NSString *)lid;
+ (NSURL *)eqeusGetLockAlarmListUrlWithBid:(NSString *)bid lid:(NSString *)lid startTime:(long long)startTime endTime:(long long)endTime;
@end
